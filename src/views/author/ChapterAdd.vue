                ...
                <ul class="log_list">
                  ...
                  <li id="contentLi">
                    <div class="ai-toolbar">
                      <el-button v-for="btn in aiButtons" :key="btn.action" :type="btn.type"
                        :disabled="!hasSelection || generating" @click="openDialog(btn.action)" size="small">
                        {{ btn.label }}
                      ...
                      <el-dialog v-model="dialogVisible" :title="dialogTitle" width="30%">
                        ...
                        ">
                          <el-input v-model.number="ratio" type="number" :placeholder="`请输入${currentAction === 'expand' ? '扩写' : '缩写'
                            }比例（1-200%）`" min="1" max="200">
                            <template #append>%</template>
                          </el-input>
                        </div>

                        <div v-if="currentAction === 'continue'">
                          <el-input v-model.number="length" type="number" placeholder="请输入续写长度（50-1000字）" min="50"
                            max="1000">
                    ...
                    <textarea ref="editor" v-model="chapter.chapterContent" name="bookContent" rows="30" cols="80"
                      id="bookContent" class="textarea" @mouseup="checkSelection" @keyup="checkSelection"></textarea>
                  </li>
                  <br />
                  ...
                  <li style="margin-top: 10px">
                    <input @click="saveChapter" type="button" name="btnRegister" value="提交" id="btnRegister"
                      class="btn_red" />
                  </li>
                </ul>
              </div>
...
export default {
  ...
  setup () {
    ...
    const saveChapter = async () => {
      ...
      await publishChapter(state.bookId, saveData);
