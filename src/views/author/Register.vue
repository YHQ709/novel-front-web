      ...
      <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic" style="line-height: 40px">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <input v-model="penName" name="penName" type="text" maxlength="8" id="TxtNiceName" class="
                  easyui-validatebox
                  inpMain
                  validatebox-text validatebox-invalid
                " data-options="required:true" validtype="checkPenName" />
            </td>
          ...
          <tr>
            ...
            <td>
              <input v-model="telPhone" name="telPhone" type="text" id="TxtMobile" class="
                  easyui-validatebox
                  inpMain
                  validatebox-text validatebox-invalid
                " data-options="required:true" validtype="chinaMobile" />
            </td>
            <td>
              <span class="notes"> *</span>
              在线小说服务系统的编辑会通过这个号码与您联系
            </td>
          </tr>
          <tr>
            <td align="right">QQ或微信：</td>
            <td>
              <input v-model="chatAccount" name="chatAccount" type="text" id="TxtQQ" class="
                  easyui-validatebox
                  inpMain
                  validatebox-text validatebox-invalid
          ...
          <tr>
            ...
            <td>
              <input v-model="email" name="email" type="text" id="TxtEmail" class="
                  easyui-validatebox
                  inpMain
                  w300
                  validatebox-text validatebox-invalid
                " data-options="required:true" validtype="email" title="" />
            </td>
        ...
        <tr>
          <td>
            <div style="padding-left: 110px; margin-top: 10px; margin-bottom: 5px">
              <input @click="registerAuthor" type="button" name="btnSubmit" value="立即开始您的作者生涯" id="btnSubmit"
                class="btn" />
            </div>
          </td>
        </tr>
